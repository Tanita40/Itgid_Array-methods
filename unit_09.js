...
const f6 = () => {
   let rev = a6;
   let res=[];
   res = rev.reverse().findIndex(item => {
...
const f7 = () => {
   ...
   // let t = a7_1.toLowerCase();
   // let res = str7.toLowerCase().lastIndexOf(t);

   let res = str7.toUpperCase().lastIndexOf(a7_1.toUpperCase());
...
const f8 = () => {
   let res = str8.toLowerCase().lastIndexOf(a8_1.toLowerCase());
   console.log(res);
