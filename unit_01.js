...
const f1 = () => {
    ...
    console.log(a1.indexOf(in1));
    document.querySelector('.out-1').innerHTML = a1.indexOf(in1);
}
...
const f4 = (arr, elem) => {
    ...
    if (arr.indexOf(elem) !== -1) {
        document.querySelector('.out-4').innerHTML = arr.indexOf(elem);
    } else {
...
const f5 = () => {
    ...
    console.log(a5.indexOf(in5_1, in5_2));
    document.querySelector('.out-5').innerHTML = a5.indexOf(in5_1, in5_2);
}
...
const f6 = () => {
    ...
    in6.toString();
    console.log(a6.indexOf(in6));
    document.querySelector('.out-6').innerHTML = a6.indexOf(in6)
}
...
const f8 = () => {
    ...
    // ваш код
    let num = a8.indexOf(in8)
    console.log(num)
    
    for ( let i = 0; i < a8.length; i++) {
        if ( num !== -1) {
            res08.push(num);
            num = a8.indexOf(in8, num+1 )
        }
...
const f9 = () => {
    ...
    for (let i = 0; i < a9.length; i++) {
        // console.log(a9[i].indexOf(in9))
        if(a9[i].indexOf(in9) !== -1) {
            console.log(a9[i]);
            arr.push(i);
            for (k in arr);
            console.log(arr[k]);
